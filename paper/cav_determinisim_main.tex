...
%
A deterministic threshold of $1m$ is insufficient when considering the spacial resolution required to resolve scenarios such as potentially dangerous close passing of cyclists and pedestrians, and a smaller value, e.g. $1mm$, may result in false positives due to the simulation \textit{noise floor}\footnote{see Fig.~\ref{CarsCollisionCG25}.} Therefore a threshold of $1cm$ is chosen. 
%
...
\subsection{Results and Analysis}\label{s:results}
