...
\begin{figure}[!t]
    ...
    \caption{Summary of results showing maximum deviation for each scenario against different resource utilisation levels. Tests 5 and 6 overlap having almost identical results. \textbf{ Change to $cm$ level in the graphs. Move 0 stress level data to 5\% to reflect simulation resources required.}}
