...
Ensuring software operates deterministically is a non-trivial task and catching intermittent failures in a test suite that cannot be replayed makes the debugging process equally difficult~\cite{acm-q-rr-interview}. 
...
%
\todo[inline]{add the ref from the google paper on using multiple threads and initialisation ordering for training ML models leads to unpredictable ordering of training data \cite{Sculley2015,Breck2017}}
%
