...
% ***************************************************
\section{Results and Discussion}\label{FinalResultsSection}
...
%
In addition, recommendations and best practice guidelines for minimising simulation variance are suggested, such as fixing the physics time step in \textit{Simulator Settings}. 
...
It is recommended that the chosen sample size is determined empirically. By increasing the sample size and observing the simulation variance does not change
...
...
