...
\todo[inline]{GC: what is ray-case?}
%
...
Compared to the vehicle dynamics simulators and traffic-level simulators used by manufacturers~\cite{FrameworkAndChallenges}, game engines offer a convenient simulation solution that meets many of the requirements for the development and functional safety testing of AVs in simulation. 
%
\todo[inline]{GC Replace: However, several challenges remain; one of these is determinism. with: However, game engines are designed principally for user experience whereas the requirements for CAV verification is not user experience but determinism.}
%
% What is a deterministic system
Deterministic, in this context, refers to the property of causality given a temporal development of events such that any state is completely determined by prior states~\cite{Schumann2010}.
%
