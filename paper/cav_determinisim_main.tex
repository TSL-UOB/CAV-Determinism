...
%
However, if a simulation is not deterministic then then there will be a variation in the generated output data. 
...
If the simulator is not deterministic then how can this variance be measured?
%
...
\subsection{Why is Determinism needed?}
...
%
A good analysis of potential sources is given by Strandberg et al.~\cite{intermittently-failing-tests} although the CAV simulation domain introduces it's own unique challenges that are not considered in this paper.
