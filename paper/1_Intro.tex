...
Game engines offer a simulation domain solution for the development and testing of CAVs that meet many of these requirements, as opposed to vehicle dynamics simulators and traffic-level simulators used my manufacturers~\cite{FrameworkAndChallenges}; but many challenges still exist.
