...
public:
	...
	static UTexture* ImportTexture(FString absFilePath, FString packagePath, bool setupAsNormalMap);
	static void SetTextureParameter(UMaterialInstanceConstant* material, const FName& paramName, const FString& baseFilePath, const FString& texturePath, const FString& packagePath, bool isNormal);
	...
	static FString MakeName(const FString inName);
