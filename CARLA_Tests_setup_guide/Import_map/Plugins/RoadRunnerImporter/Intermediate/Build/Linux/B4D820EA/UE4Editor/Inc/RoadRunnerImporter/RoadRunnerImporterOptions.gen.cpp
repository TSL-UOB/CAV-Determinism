...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_URoadRunnerImporterOptions_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_URoadRunnerImporterOptions_Statics::PropPointers),
		0,
		0x000800A4u,
		METADATA_PARAMS(Z_Construct_UClass_URoadRunnerImporterOptions_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_URoadRunnerImporterOptions_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(URoadRunnerImporterOptions, 28454077);
