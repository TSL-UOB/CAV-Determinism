...
\addbibresource{\pathToSourceFiles/cav_determinism.bib}
\usepackage{array}
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage{amssymb}
...
% RUN THIS FIRST ---->>>>>>>
% 
% latexdiff document/source/second_submit_body.tex document/source/body.tex > document/ieee_trans/diff/diff_v3.tex
% 
\input{diff_v3.tex}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{\pathToOtherFiles/mugs/greg.png}}]{Greg Chance}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{\pathToOtherFiles/mugs/abanoub}}]{Abanoub Ghobrial}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{\pathToOtherFiles/mugs/kevin.jpg}}]{Kevin McAreavey}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{\pathToOtherFiles/mugs/severin}}]{S\'everin Lemaignan}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{\pathToOtherFiles/mugs/tony}}]{Tony Pipe} 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{\pathToOtherFiles/mugs/kie}}]{{Kerstin Eder}} 
