...
Thank you, we agree this would help describe the scene better to the reader. Please see section V.C on page 7 for the additional text: \textit{The map size for the simulation test environment was 354x170$m$. The range of movement of the actors within the environment was up to 70m for vehicles and up to 25m for pedestrians}.
...
We agree the paper is a bit long, however if readers are familair with the definitions it is likely that they will skip over these but it would be prudent to keep them in. We think that section 5 and 6 are already long independently and combining them might become unweildy. 

We have attempted to reduce the paper size in different areas, please see the diff document. However, as the first reviewer wanted additional material added this may have resulted in a net gain in overall length.
...
Giving a relative comparison is not easily achieved as each source would be difficult to quantify. Hopefully it is clear from Table.1 that pedestrian-vehicle collisions result in high simulation variance in our case study, and also the role that resource utilisation plays should be clear to the reader from veiwing Fig.4. However, writing this as a general description would be difficult. However, if the reader follows the methodology in section 7 they should be able to discover the principle sources, quantify them and proritise those which may lead to simulation variance above the permissible level for the user.
...
Thank you, this is a great idea and we take on board your idea that this would give the reader a better insight into the issue. We have added an X-Y position data plot showing high simulation variance on page XX...
